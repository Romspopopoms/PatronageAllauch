...
const Quisommesnous2 = () => { 
    return (
        <div className="h-auto w-auto flex flex-col justify-center items-center gap-y-24">
            <div className="text-5xl font-bold font-kalam text-secondary text-center">L'équipe Permanente</div>
            <div className="flex flex-row gap-x-12 ">
                <img src={Marie} alt="Marie" className="w-auto h-auto object-cover" />
                <div className="flex flex-col gap-y-4">
                <div className="text-4xl font-extrabold font-kalam text-accent text-center">Marie-Amélie Marinho</div>
                <div className="text-2xl font-semibold font-kalam text-[#74A7BE] text-center">Directrice du Patronage.</div>
                <p className="font-laila text-[#74A7BE] text-center">Marie-Amélie à valider une licence en psychologie.<br></br>
            ...
            <div className="flex flex-row gap-x-12 ">
                ...
                <p className="font-laila text-[#74A7BE] text-center">Directeur adjoint du Patronage.
                ...
                <img src={Jb} alt="Jb" className="w-auto h-auto object-cover" />
                
            </div>

            <div className="flex flex-row gap-x-12 ">
                <img src={Père} alt="PèreMatthieu" className="w-auto h-auto object-cover" />
                <div className="flex flex-col gap-y-4">
                ...
                <p className="font-laila text-[#74A7BE] text-center">Après 8 ans au séminaire Saint Luc d’Aix, l’Abbé Matthieu fut <br></br>
            ...
            <div className="text-5xl font-bold font-kalam text-secondary text-center">Nos bénévoles et animateurs ponctuels</div>

            <div className="flex flex-row gap-x-12 ">
                <img src={Bénévoles} alt="NosBénévoles" className="w-auto h-auto object-cover" />
                <div className="flex flex-col gap-y-4">
                <div className="text-4xl font-extrabold font-kalam text-accent text-center">Nos bénévoles</div>
                
                <p className="font-laila text-[#74A7BE] text-center">Le Patronage reçois chaque jours l’aide de nombreux bénévoles, <br></br>
            ...
            <div className="flex flex-row gap-x-12 ">
                ...
                <p className="font-laila text-[#74A7BE] text-center">Que ce soit des stagiaires ou titulaires du BAFA, de nombreux <br></br>
                ...
                <img src={Autres} alt="AnimateursPonctuels" className="w-auto h-auto object-cover" />             
            </div>
        </div>
    )
}
